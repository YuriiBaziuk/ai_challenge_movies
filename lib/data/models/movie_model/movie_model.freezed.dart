...
class _$_MovieModel implements _MovieModel {
  _$_MovieModel({required this.id, required this.name, required this.price});
  ...
  @override
  String toString() {
    return 'MovieModel(id: $id, name: $name, price: $price)';
  }
...
abstract class _MovieModel implements MovieModel {
  factory _MovieModel(
      ...
      required final num price}) = _$_MovieModel;
